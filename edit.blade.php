            ...
            <form action="{{ url('menu/'.$menu->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="my-3 p-3 bg-dark rounded">
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <select id="jenis" name="jenis" class="form-select">
                        <option value="breakfast" {{ (old('jenis', isset($data) ? $data->jenis : '') == 'breakfast') ? 'selected' : '' }}>Breakfast</option>
                        <option value="lunch" {{ (old('jenis', isset($data) ? $data->jenis : '') == 'lunch') ? 'selected' : '' }}>Lunch</option>
                        <option value="dinner" {{ (old('jenis', isset($data) ? $data->jenis : '') == 'dinner') ? 'selected' : '' }}>dinner</option>
                        </select>
                    </div>
                </div>
                  <div class="mb-3 row">
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                    <img src="{{ asset("menu-images/$menu->img") }}" class="card-img img-fluid object-fit-cover" style="width:7rem; height:7rem;" alt="image">
